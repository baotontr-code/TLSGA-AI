...
<div class="main-header">
    ...
    <p>Tác giả: Triệu Tôn Bảo - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0369463622</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Triệu Tôn Bảo - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0369463622</div>", unsafe_allow_html=True)
